...
export default function UnitConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-pink-800 to-pink-50">
      {/* Center the unit converter card within the screen */}
      <div className="max-w-md w-full p-6 bg-card rounded-lg shadow-lg">
       <b> <u><h1 className="text-2xl font-bold mb-1 text-blue-800 text-center">Unit Converter</h1></u></b>
       <b> <p className="text-sm mb-8 text-center">
